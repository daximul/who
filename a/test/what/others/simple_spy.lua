...
local Highlight = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/daximul/randompost/main/syntax_highlighting.lua"))();
...
--- @param blocked any
newRemote = function(type, name, args, remote, function_info, blocked, src)
...
--- Handles remote logs
remoteHandler = function(hookfunction, methodName, remote, args, func, calling)
...
--- Used for hookfunction
hookRemote = function(remoteType, remote, ...)
    local args = {...}
